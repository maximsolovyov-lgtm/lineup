...
Evidence and releases beyond `evidence_source`, ingestion, OCR, predictions
generated by an agent, favourites, notifications, public pages.

Schedule entry (Line-ups and Sets) was moved into scope on 2026-09-20 by the
owner, once this stage's master data was in use — see the stage boundary in
