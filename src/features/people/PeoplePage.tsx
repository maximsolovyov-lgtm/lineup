    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center gap-2">
        <div className="mr-auto">
          ...
          <p className="text-sm text-muted-foreground">The humans behind stage names. Users follow artists, not people.</p>
        </div>
        <Input type="search" placeholder="Search name, country…" className="w-64" value={q} onChange={(e) => setQ(e.target.value)} aria-label="Search people" />
